...
import com.spring.boot.BlogApp.service.CommentService;
...
public class CommentController {
	...
	public ResponseEntity<CommentDto> createDto(@RequestBody CommentDto comment,@PathVariable Integer postId){
